...
def createTrackbar():
    ...
    cv2.createTrackbar("conversionType", "conversion parameter", 0, 6, nothing)
...
while True:
    ...
    cv2.putText(pictureMorphologyTransform, '0 - DILATE', (10, 20 + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    cv2.putText(pictureMorphologyTransform, '1 - ERODE', (10, 20 + 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    cv2.putText(pictureMorphologyTransform, '2 - OPEN', (10, 20 + 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    cv2.putText(pictureMorphologyTransform, '3 - CLOSE', (10, 20 + 80), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    cv2.putText(pictureMorphologyTransform, '4 - GRADIENT', (10, 20 + 100), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    cv2.putText(pictureMorphologyTransform, '5 - TOPHAT', (10, 20 + 120), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    cv2.putText(pictureMorphologyTransform, '6 - BLACKHAT', (10, 20 + 140), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
